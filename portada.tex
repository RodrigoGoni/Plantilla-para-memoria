...
\begin{titlepage}
    ...
    \begin{flushright}
        ...
        Optimización biomecánica del ciclismo asistida por inteligencia artificial} \\[1.5cm]

        % Autor
        {\fontfamily{phv}\fontsize{20pt}{25pt}\selectfont
        Ing. Rodrigo Iván Goñi} \\[1cm]
        ...
        \textbf{Director:} MSc. Fernando Corteggiano} \\[1cm]

        % Jurados
        {\fontfamily{phv}\fontsize{11pt}{15pt}\selectfont
        \textbf{Jurados:}} \\[0.5cm]
        {\fontfamily{phv}\fontsize{11pt}{15pt}\selectfont
        Dr. Ing. David Marcelo De Yong (UNRC)} \\ 
        {\fontfamily{phv}\fontsize{11pt}{15pt}\selectfont
        Esp. Ing. Fernando Monzón (UNCuyo / FIUBA)} \\ 
        {\fontfamily{phv}\fontsize{11pt}{15pt}\selectfont
        Ing. Octavio Deshays (UNCuyo)} \\[2cm]

        % Fecha y lugar
        {\fontfamily{phv}\itshape\fontsize{10pt}{12pt}\selectfont
        Ciudad de Mendoza, 2026}
    \end{flushright}
\end{titlepage}
