...
en tiempo real, se implementó un filtro de Kalman lineal basado en un modelo
...
Se empleó el método de Newton-Euler recursivo \citep{Winter2009_Biomechanics},
...
Los momentos generados por las fuerzas en el pedal respecto al CM del pie son:
...
Este proceso se repitió recursivamente para el segmento del muslo (thigh) para
