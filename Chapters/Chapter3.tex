...
%	METODOLOGÍA
%----------------------------------------------------------------------------------------
\section{Metodología de trabajo adoptada}
...
\begin{figure}[H]
  ...
  \includegraphics[width=0.65\textwidth]{./Figures/crispdm.pdf}
...
recomendaciones biomecánicas accionables y deterministas. El flujo lógico de
datos se conceptualiza en el diagrama de bloques de la figura
\ref{fig:arquitectura_sistema}.

\begin{figure}[H]
  \centering
  \includegraphics[width=0.9\textwidth]{Figures/Arquitectura_Pipeline.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=.90\textwidth]{Figures/esqueleto.png}
...
\begin{table}[h]
  \centering
  \caption{Configuración de operadores del algoritmo genético NSGA-II implementado.}
