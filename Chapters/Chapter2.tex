...
\begin{table}[htbp]
      ...
      \centering
      \small
      \begin{tabular}{p{0.20\linewidth}p{0.14\linewidth}p{0.14\linewidth}p{0.37\linewidth}}
            \toprule
...
\begin{itemize}
      \item Selección: determina qué individuos de la población actual se reproducirán,
...
\begin{table}[htbp]
      ...
      \centering
      \small
      \begin{tabular}{p{0.11\linewidth}p{0.21\linewidth}p{0.43\linewidth}p{0.10\linewidth}}
            \toprule
