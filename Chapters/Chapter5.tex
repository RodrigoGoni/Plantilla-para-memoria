...
\begin{itemize}
    ...
    \item La integración de sensores de potencia avanzados, como los pedales
          Garmin Rally RK\,200, que proporcionan métricas de alto valor biomecánico:
          pico de fuerza por fase de pedaleo, balance de potencia izquierda/derecha
          (L/R), eficiencia de torque, tiempo en la zona de fuerza máxima y fase de
          pedaleo efectivo (\textit{Power Phase}). La incorporación de estas señales
          permitiría calibrar y validar el modelo de fuerzas estimado actualmente por
          cinemática inversa, enriqueciendo las funciones objetivo de la
          optimización con datos de carga real.
