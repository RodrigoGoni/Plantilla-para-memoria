...
\begin{itemize}
    ...
    \item Se resolvió el problema de desenfoque de movimiento mediante la sustitución de
          la cámara original por un dispositivo Google Pixel 8~Pro, con mejoras en la
    ...
    \item Se alcanzó un grado de cumplimiento de los requerimientos del 89\,\%, con 26 de
          29 criterios de aceptación cumplidos, un criterio parcialmente cumplido y dos
...
selección de cámara, donde se manifestaron dos de los riesgos identificados: la
baja calidad de imagen por desenfoque de movimiento y la consecuente
inexactitud del modelo de pose. El plan de mitigación resultó efectivo y
permitió retomar el cronograma con un retraso acotado.
...
\begin{itemize}
    ...
    \item La validación del sistema con una muestra ampliada de ciclistas de distintos
          ...
          recomendaciones.
    \item La integración de sensores de potencia avanzados, como los pedales
          Garmin Rally RK\,200, para calibrar y validar el modelo de fuerzas estimado
          por cinemática inversa, lo que enriquecería las funciones objetivo con datos de
          carga real.
